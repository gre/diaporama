...
function Diaporama (container, data, opts) {
  ...
  delete opts.renderingMode; // removing renderingMode from the options because it has been handled and we don't want it to be set later.
  this._rendering = createRendering(container, opts.backgroundColor || this.backgroundColor, this._renderingMode);
