  ...
  _computeTimelineSegments: function () {
    ...
    for (var i = 0; i < tlength; i++) {
      ...
      if (item.image) {
        ...
        if (i===0) {
          extraLoopSegment = new this._rendering.SegmentVideo(Channels.KENBURNS[channelIndex], item);
        }
        segment = new this._rendering.SegmentVideo(Channels.KENBURNS[channelIndex], item);
      }
      else if (item.slide2d) {
