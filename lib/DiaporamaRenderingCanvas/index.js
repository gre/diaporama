...
function DiaporamaRenderingCanvas (container, bgColor) {
  ...
  var shape = this._shape = [ 1, 1 ];

  var canvas = document.createElement("canvas");
  var gl = canvas.getContext("webgl");

  this._postFBO = createFBO(gl, shape);
