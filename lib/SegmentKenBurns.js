...
SegmentKenBurns.prototype = assign({}, SegmentTimeline.prototype, {
  ...
  render: function (p) {
    if (!this.fromToSameBound || this._dirty) {
      this._dirty = false;
  ...
  cropBound: function (crop) {
    var image = this.image;
    var bnds = crop(this.getSize ? this.getSize() : this.div, image);
  ...
  computeBounds: function () {
    ...
    this.fromToSameBound = sameBound(this.fromCropBound, this.toCropBound);
    this._dirty = true;
  }
});
